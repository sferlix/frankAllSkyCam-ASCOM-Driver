...
public sealed class StatusForm : Form
{
    ...
    public StatusForm(WeatherState state)
    {
        ...
        Text = "AllSky Weather - Stato";
        BackColor = Background;
        ClientSize = new Size(20 + 3 * 190 + 2 * 14 + 20, 64 + 20 + 4 * 108 + 3 * 14 + 20);
        FormBorderStyle = FormBorderStyle.FixedDialog;
        MaximizeBox = false;
        StartPosition = FormStartPosition.CenterScreen;
        Icon = TrayIconFactory.CreateIcon();

        _headerPanel = new Panel { Dock = DockStyle.Top, Height = 64, BackColor = Background };
        _headerPanel.Paint += HeaderPanel_Paint;

        var titleLabel = new Label
        {
            Text = "AllSky Weather",
            Font = new Font("Segoe UI", 15f, FontStyle.Bold, GraphicsUnit.Pixel),
        ...
        _subtitleLabel = new Label
        {
            ...
            Font = new Font("Segoe UI", 10.5f, FontStyle.Regular, GraphicsUnit.Pixel),
            ForeColor = TextMuted,
            BackColor = Color.Transparent,
            AutoSize = true,
        ...
        _temperature = new MetricCard(WeatherIcons.Thermometer, AccentTemp, "Temperatura") { Margin = new Padding(7), Dock = DockStyle.Fill };
        _humidity = new MetricCard(WeatherIcons.Droplet, AccentHumidity, "Umidita") { Margin = new Padding(7), Dock = DockStyle.Fill };
        _dewPoint = new MetricCard(WeatherIcons.Droplet, AccentHumidity, "Punto di rugiada") { Margin = new Padding(7), Dock = DockStyle.Fill };
        _pressure = new MetricCard(WeatherIcons.Gauge, AccentPressure, "Pressione") { Margin = new Padding(7), Dock = DockStyle.Fill };
        _cloudCover = new MetricCard(WeatherIcons.Cloud, AccentCloud, "Copertura nuvolosa") { Margin = new Padding(7), Dock = DockStyle.Fill };
    ...
    private void HeaderPanel_Paint(object? sender, PaintEventArgs e)
    {
        ...
        e.Graphics.FillEllipse(dotBrush, 20, 42, 8, 8);
    }
